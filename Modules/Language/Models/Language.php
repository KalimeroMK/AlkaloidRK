<?php
     ...
     * @property-read \Kalnoy\Nestedset\Collection|Category[] $score
     * @property-read int|null $score_count
     * @property-read \Kalnoy\Nestedset\Collection|Category[] $team
    ...
    class Language extends Model
    {
         ...
         * @return BelongsToMany
         */
        public function setting(): BelongsToMany
        {
            return $this->belongsToMany(Setting::class)->withPivot('title', 'description', 'address');
        }
    }
