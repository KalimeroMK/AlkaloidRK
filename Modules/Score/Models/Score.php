<?php
    ...
    class Score extends Model
    {
        ...
        public function getImageUrl1Attribute(): ?string
        {
            if ( ! empty($this->team1logo)) {
                return asset('/uploads/images/score/'.$this->team1logo);
            }
        ...
        {
            if ( ! empty($this->team2logo)) {
                return asset('/uploads/images/score/'.$this->team2logo);
            }
